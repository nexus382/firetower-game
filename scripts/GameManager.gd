...
func get_mode_briefing(mode: String) -> Dictionary:
    ...
    var baseline_lines: PackedStringArray = [
        ...
        "Hiking legs run %.1f to %.1f hours with %.0f%% rest and %d calories per trip when enabled." % [TRAVEL_HOURS_MIN, TRAVEL_HOURS_MAX, TRAVEL_REST_COST_PERCENT, TRAVEL_CALORIE_COST]
    ]
