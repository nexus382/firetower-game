# debug_test.gd overview:
# - Purpose: quick viewport sanity pass that mirrors TowerManager math without scene setup.
# - Sections: _init() spins up layout calculations, logs results, then exits cleanly.
extends SceneTree
